...
class CGVHD_DataSets(FixtureParameterFactory):
    ...
    true_ci_Aalen = np.empty(shape=(2, 3, 75), dtype=_ci_Aalen.dtype)
    true_ci_Aalen[0], true_ci_Aalen[1] = _ci_Aalen[0:3], _ci_Aalen[3:]

    true_ci_Dinse = np.array(
        [
            [
                [
                    0.00000000e00,
...
class TestCumIncCompetingRisks:
    ...
    def test_ci(event, time, true_x, true_y):
        ...
        true_ci = CGVHD_DataSets().true_ci_Aalen
        ci_1 = ci[:, 1:, :]
    ...
    def test_dinse_ci_regression(event, time, true_x, true_y):
        ...
        true_ci = CGVHD_DataSets.true_ci_Dinse
        assert_array_almost_equal(ci, true_ci)
