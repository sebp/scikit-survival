...
def load_whas500():
    ...
    """
    fn = importlib_resources.files(__name__) / 'data' / 'whas500.arff'
...
def load_gbsg2():
    ...
    """
    fn = importlib_resources.files(__name__) / 'data' / 'GBSG2.arff'
...
def load_veterans_lung_cancer():
    ...
    """
    fn = importlib_resources.files(__name__) / 'data' / 'veteran.arff'
...
def load_aids(endpoint="aids"):
    ...
    fn = importlib_resources.files(__name__) / 'data' / 'actg320.arff'
...
def load_breast_cancer():
    ...
    """
    fn = importlib_resources.files(__name__) / 'data' / 'breast_cancer_GSE7390-metastasis.arff'
...
def load_flchain():
    ...
    """
    fn = importlib_resources.files(__name__) / 'data' / 'flchain.arff'
