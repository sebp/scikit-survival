...
class BaseSurvivalSVM(BaseEstimator, metaclass=ABCMeta):
    ...
    def fit(self, X, y):
        ...
        y : structured array, shape = (n_samples,)
            ...
            (e.g., named 'event') as the first field, and time of event
            or time of censoring (e.g., named 'time') as the second field.
...
class FastSurvivalSVM(BaseSurvivalSVM, SurvivalAnalysisMixin):
    ...
    random_state : int, :class:`numpy.random.RandomState` instance, or None, optional, default: None
        Used to resolve ties in survival times. Pass an int for reproducible output across multiple function calls.
