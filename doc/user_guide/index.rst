...
The User Guide covers the most important aspects of doing survival analysis with scikit-survival.
...
Once you are familiar with the basics, it is highly recommended to read the guide :ref:`/user_guide/evaluating-survival-models.ipynb`,
